...
S2 = sec('measures', ["¶4.1.3", "¶4.3–4.6", "s.2(1) Sch. 2"], ("The four measures, and how hard each one verifies", "四項措施，以及各自核實的嚴格程度"),
    ...
    + B("<b>Trust:</b> name, date of settlement, governing law, any official ID number, registered office.", "<b>信託：</b>名稱、成立或結算日期、規管法律的司法管轄區、官方識別號碼（如有）、註冊辦事處。") + '' + cite_html("¶4.3.11") + '</td>'
    ...
    + td("Reliable and independent: a governmental body; the CCE or another relevant authority; an authority outside Hong Kong that performs similar functions; a CCE-recognised digital identification system; any other CCE-recognised source.",
    ...
    + td("Obtain information on the purpose and intended nature of the business relationship, unless it is obvious. For a customer that is not a natural person, also understand the nature of its business.", "取得業務關係的目的及擬具有的性質的資料，除非顯而易見。客戶並非自然人時，亦應了解其業務性質。", "¶4.1.3(c), 4.6.1")
...
S3 = sec('bo', ["¶4.4", "s.1–2 Sch. 2"], ("Beneficial owner: follow the chain to a natural person", "實益擁有人：沿擁有權鏈追蹤至自然人"),
    ...
    + U.table([U.th("If the customer is", "如客戶是"), U.th("Its beneficial owner is", "其實益擁有人是")], [
        ...
        U.tr(U.rh("A trust", "信託", "¶4.4.10–4.4.12 · s.1 Sch. 2"), U.td("The settlor; the trustee; any protector or enforcer; beneficiaries, or a class of them, entitled to a vested interest in the trust property; and any individual with ultimate control, including through a chain. For a class of beneficiaries, obtain enough to identify them at payout or when they exercise their rights",
                                                                                     "財產授予人；受託人；保護人或執行人（如有）；有權享有信託財產的既得權益的受益人或某類別受益人；以及擁有最終控制權的個人（包括透過控制或擁有權鏈）。按類別指定的受益人，應取得足夠資料，以便在付款或行使權利時確定其身分")),
        U.tr(U.rh("An unincorporated body other than a partnership", "除合夥外的非法團團體", "¶4.4.8 · s.1 Sch. 2"), U.td("An individual who ultimately owns or controls it, or the person it acts for", "最終擁有或控制該團體的個人，或該團體代其行事的人")),
        ...
        U.tr(U.rh("A complex structure", "擁有權或控制權結構複雜", "¶4.4.4, 4.4.14"), U.td("Find who has ultimate ownership or control over the customer, or who constitutes its controlling mind and management, and obtain enough to be satisfied the structure has a legitimate reason", "找出誰是最終擁有或控制客戶的人，或誰是控制及管理客戶的主腦；並取得足夠資料，信納採用該架構有合法理由")),
    ], minw=700)
    + U.traps(
