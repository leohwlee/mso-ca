...
def fig_secret():
    ...
    REGR = NCard(LX, CW, ("Must not pass on what it learns, or let anyone see the records", "{不得}傳達所{獲悉的事宜}，亦{不得}讓他人取覽{紀錄}"),
                ("Anything learned, and any record obtained, through an appointment or a function under the Ordinance. Gateways include performing a function, criminal proceedings or an investigation in Hong Kong, and a court order. The Commissioner has more, including to other regulators",
                 "凡憑藉{根據本條例}{獲委任}，或在執行或協助{執行職能}的{過程中}{獲悉}的事宜及{取得}的{紀錄}，均{受約束}。准許的途徑{包括}{執行職能}、在香港進行的{刑事法律程序}或{調查}，以及{法院命令}。{關長}另有{其他}途徑，{包括}向{其他}{監管機構}{披露}"),
    ...
    ON = NCard(150, 700, ("Specified recipients: whoever receives it through most gateways, and anyone who gets it from them", "{指明收取人}：經大部分{准許途徑}獲{披露}{資料}的人，以及從其處{取得}{資料}的人"),
    ...
    b.append(_route_label((lx + la) / 2, ky - 7, ("through most gateways", "經大部分准許途徑")))
    b.append(_route_label((rx + ra) / 2 - 22, ky - 7, ("with consent or most conditions", "經同意或符合大部分條件")))
    aria = ("Who must keep information secret. Specified persons on the regulator's side must not pass on anything they learn, or any record they obtain, through an appointment or a function under the Ordinance, unless a gateway applies, on pain of $1,000,000 and two years. The licensee, once a section 9 or 12 requirement is imposed or a section 22 or 44 notice is given, must not disclose what it learns from it unless the Commissioner consents or one of four conditions applies, on pain of a level 4 fine. Whoever receives the information through most gateways, and anyone who gets it from them, must not pass it on either, on pain of $1,000,000 and two years; someone the licensee tells only information that is already lawfully public is not bound.",
            "誰須保密。監管方的指明人士，對憑藉根據本條例獲委任、或在執行或協助執行職能的過程中獲悉的事宜及取得的紀錄，除非屬准許的途徑，否則不得傳達，違者可處罰款$1,000,000及監禁2年。持牌人一旦被施加第9或12條的要求或獲發第22或44條的通知，除非獲關長同意或符合四項條件之一，否則不得披露從中獲得的資料，違者可處第4級罰款。經大部分准許途徑獲披露資料的人，以及從其處取得資料的人，同樣不得再向他人披露，違者可處罰款$1,000,000及監禁2年；持牌人只向其披露已合法公開資料的人，則不受此約束。")
...
A = sec('who', [("Part 6A", "第6A部"), "s.76A–s.76G", ("added 2022", "2022年增補")],
    ...
    P("Read the two columns separately: the left one is the regulator's duty, the right one is yours. They differ in what they cover and in the penalty. The wide box below both columns catches most people the information is lawfully passed on to, whichever side passed it.",
      "兩欄分開閱讀：左欄是監管方的責任，右欄是你的責任。兩者涵蓋的範圍和罰則都不同。兩欄下方的闊方格涵蓋大部分經准許途徑獲得資料的人，不論資料由哪一方披露。")
    ...
    + traps(
        ...
        trap(("It is not only the licensee who is bound", "受約束的不只是持牌人"),
             ("Section 76E catches any person on whom a section 9 or 12 requirement has been imposed. A bank or another third party asked to produce your records is bound in the same way as you are.",
              "第76E條涵蓋任何被施加第9或12條要求的人。被要求交出你紀錄的銀行或其他第三方，與你一樣受到約束。"),
...
B_ = sec('you', ["s.76E", ("your duty", "你的責任")],
    ...
    + traps(
        trap(("Public, but lawfully public", "公開，但須是合法公開"),
             ("The condition is not simply that the information is out there. It must have become public through a disclosure section 76B does not forbid. A leak in breach of section 76B, for example by a C&amp;ED officer or another specified person, does not release you.",
              "條件並非只要資料已流出即可，而是必須經由第76B條沒有禁止的披露而公開。違反第76B條的洩露（例如由海關人員或其他指明人士洩露）並不能解除你的責任。"),
             "s.76E(4)(a)"),
    ))
...
C_ = sec('gateways', ["s.76C", "s.76D", "s.76E(4)", "s.76G"],
    ...
    P("A tick means that gateway is open to that holder of the information. The Commissioner is also a specified person, so every tick in the first column is open to him as well.",
      "剔號表示該途徑對該資料持有人開放。關長本身亦屬指明人士，故第一欄的每個剔號對他同樣適用。")
    + table([th("Gateway", "准許披露的途徑"), th("Any specified person", "任何指明人士"), th("The Commissioner, as relevant authority", "關長（以有關當局身分）"), th("You, the licensee", "你（持牌人）")], [
        ...
        grow("To eighteen listed officials and bodies, among them the Chief Executive, the Financial Secretary, the other financial regulators and the ICAC, if desirable in the public interest and the recipient needs it", "向十八個指明的人員及機構（包括行政長官、財政司司長、其他金融監管機構及廉政專員），但須顧及公眾利益並屬可取，而接收者亦有需要", (0, 1, 0), "s.76D(1)(g), (2)"),
        grow("Inspection or investigation material, to the Secretary for Justice, the Police, the ICAC or the Review Tribunal", "視察或調查所得資料，向律政司司長、警務處處長、廉政專員或覆核審裁處", (0, 1, 0), "s.76D(1)(h)"),
    ...
    + traps(
        trap(("Two gateways carry a public-interest test", "兩條途徑須符合公眾利益準則"),
             ("Passing information to the listed officials and bodies, or to an overseas regulator, is allowed only if the Commissioner is satisfied it is desirable or expedient, having regard to the public interest and the recipient's need for it. The other gateways have no such test.",
              "向指明人員及機構或香港以外監管機構披露資料，只有在關長經顧及公眾利益及接收者的需要，信納披露屬可取或合宜時，方可進行。其他途徑並無此準則。"),
             "s.76D(2)"),
    ))

P6A_NAV = [('who', 'Two duties of secrecy', '兩項保密責任'), ('you', 'Who you may tell', '你可以告訴誰'),
           ('gateways', 'Disclosure gateways', '准許披露的途徑')]
P6A_BODY = A + B_ + C_
